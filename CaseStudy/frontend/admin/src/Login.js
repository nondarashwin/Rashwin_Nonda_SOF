    ...
    this.setState(st)
     ...
     render() {
         return(<div><nav className="navbar navbar-expand-lg navbar-dark bg-primary">
             ...
             <div className="jumbotron"style={{backgroundColor:"white",padding:"10px",align:"center",border: "1px groove black",margin: 0,
                 position: "absolute",top:"20%",left: "40%"}}>
                 <div align="center"><img width="100" src="/img/bitmap.png"/></div>
                 <h5> Log In</h5>
             <form onSubmit={this.handleSubmit.bind(this)}>
                 <div className="form-group">
                     <label htmlFor="userName">userid</label><input className="form-control"type="text" onChange={this.handleEvent.bind(this)} name="storeId"  id="storeId"/>
                 </div>
                 <div className="form-group">
                     <label htmlFor="password">password</label><input className="form-control"type="password" name="password" onChange={this.handleEvent.bind(this)} id="password"/>
                 </div>
