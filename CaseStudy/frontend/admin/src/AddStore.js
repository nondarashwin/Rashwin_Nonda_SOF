...
class AddStore extends Component{
    ...
    handleSubmit(event) {
        ...
        axios.post("http://localhost:9090/api/store", this.state.store)
            .then(res => {
                ...
                let store=res.data;
                axios.post("http://localhost:9090/api/storepassword",{storeId:store.id,mailId:this.state.mailId,password:"password"}).then(res1=>{
    ...
    storeForm(){
        return(
            <div><LoginVerifier check="admin"/><Navbar/><div className="row">
                ...
                <div className="col-3">
                    <div className="jumbotron" style={{backgroundColor:"white",padding:"10px",align:"center",border: "3px solid black",margin: 0,
                        ...
                        <form onSubmit={this.handleSubmit.bind(this)}>
                            ...
                            <div className="form-group">
                                <label>Email</label><input type="text" name="mailId" value={this.state.mailId}
    ...
    render() {
        console.log("yes")
        return this.state.loading? <div style={{align:"center",margin: 0,position: "absolute",top:"50%",left: "50%"}}><Loading/></div> : this.storeForm()
    }
}
