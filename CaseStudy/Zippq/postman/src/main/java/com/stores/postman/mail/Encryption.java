package com.stores.postman.mail;
...
public class Encryption {
    ...
    public String decrypt(String codedString) throws IOException {
        ...
        File file = new File("/home/rashwin/Project/Rashwin_Nonda_SOF/CaseStudy/Zippq/postman/src/main/java/com/stores/postman/mail/key.txt");
