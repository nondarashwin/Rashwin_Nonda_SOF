    ...
    public ServletContextInitializer initializer()
    {
        return new ServletContextInitializer()
        {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "com.manipal");
                servletContext.setInitParameter("tapestry.development-modules", "com.manipal.services.DevelopmentModule");
